const html = `
    <link rel='stylesheet' href='https://search.apps.cs61a.org/search.css' type='text/css'>
...
const search = async (query, limit) => {
    ...
    const { piazza, resources } = await (await fetch("https://search-worker.apps.cs61a.org/query", {
        method: "POST",
        headers: {
